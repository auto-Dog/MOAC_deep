...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--CFO', type=float, default=0, help="CFO")
    parser.add_argument('--short', type=float, default=0, help="short or long pkt")
    parser.add_argument('--Aligned', type=float, default=0, help="Aligned or not")
    ...
    parser.add_argument('--Estimator', type=float, default=1, help="1->naive,2->LMMSE")
